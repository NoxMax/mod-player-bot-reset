-- Bot Reset Guild Tracker Table
-- This table tracks guilds that have real (non-bot) players to prevent bot resets
-- when real players are in the guild, even when they are offline.

DROP TABLE IF EXISTS `bot_reset_guild_tracker`;

CREATE TABLE `bot_reset_guild_tracker` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tracks guilds with real players for bot reset restrictions';